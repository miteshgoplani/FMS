package codeperfect.javaproject.filemanager;
...
public class FileUtility {
    ...
    private static final String extractFolder = "F:\\";

    //private static final String encryptedFileLocation = "F:\\Encrypted Files\\";
	private static final String encryptedFileLocation = "F:\\";
    //private static final String decryptedFileLocation = "F:\\Decrypted File\\";
	private static final String decryptedFileLocation = "E:\\";
    ...
    public static void createDirectory(String inputDirectory) {
        ...
        if (file.exists()) {
            System.out.println("The directory "+a+" is already present");
        } else {
            //use mkdirs() or mkdir() and check its return value
			boolean dirStatus=file.mkdirs();
			if(dirStatus)
			{
				System.out.println("Directory "+a+" Successfully Created!");
			}
			else{
				System.out.println("Error in creating the directory.."+ a+".");	
			}
    ...
    public static void reNameDirectory(String inputFile, String newDirName) {
        ...
        if (file.isDirectory()) {
            ...
            System.out.println("Directory not found. Invalid path.");
        }
...
// --------------
    ...
    public static void decompress(String zipFile){
      try{
		File destFile=new File(extractFolder);
	...
	public static void decompress(String zFile)throws IOException {
		...
		// write the current file to disk
		   ...
		   BufferedOutputStream dest= new BufferedOutputStream(fos,BUFFER);
		   System.out.print("\n File has been Decompressed successfully..! to folder F:\\ \n");
		  // read and write until last byte is encountered
		  int currentByte;
		  while ((currentByte= is.read(data,0,BUFFER)) != -1) {
		  dest.write(data, 0, currentByte);
